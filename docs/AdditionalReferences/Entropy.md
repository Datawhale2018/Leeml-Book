...
#### 信息熵公式的理解：
##### 信息量
 假如说，一个事件A：你买了一本书，另一个事件B：你将《李宏毅机器学习》的内容全都搞懂了。你买到一本书所需的信息量是非常少的，你将《李宏毅机器学习》的内容全都搞懂了这所需要的信息量是非常大的，如何度量这个事件的信息量呢？事件A的信息量表示为H(A)，事件B的信息量表示为H(B)。两者比较为：$H(A)<H(B)$。
